-- VINTAGE · production · invitation wording (applies migration 0010)
--
-- Optional and cosmetic. Run it whenever convenient; nothing breaks without
-- it. Paste into the Supabase SQL Editor and run.
--
