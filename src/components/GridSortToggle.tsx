...
/**
 * The one control over a grid: the order it reads in.
 *
 ...
 * order a shoebox of prints is in. Two words in tracked mono, the current
 * one in ink — a mark on the contact sheet, not a segmented control.
 */
export function GridSortToggle({ value, onChange }: { value: GridSort; onChange: (next: GridSort) => void }) {
  return (
